...
const TableMock = class {
    ...
    findFirst({ where }) {
        ...
        keys.forEach((key) => {
            matchingRecords = matchingRecords.filter((record) => record[key] === where[key]);
        });
...
const createDbUser = async (attributes = {}) => {
    return await db.user.create({
        data: {
            ...
            hashedPassword: "0c2b24e20ee76a887eac1415cc2c175ff961e7a0f057cead74789c43399dd5ba",
...
describe("dbAuth", () => {
    ...
    describe("constructor", () => {
        ...
        it("does not throw an error if no forgotPassword.handler option but forgotPassword.enabled set to false", () => {
            ...
            })).not.toThrow(dbAuthError.NoForgotPasswordHandlerError);
        });
    ...
    describe("invoke", () => {
        ...
        it("handlers CORS OPTIONS request", async () => {
            ...
            expect(response.headers["access-control-allow-origin"]).toBe("https://www.myRedwoodWebSide.com");
        });
    ...
    describe("forgotPassword", () => {
        ...
        it("sets the resetToken and resetTokenExpiresAt on the user", async () => {
            ...
            expect(responseBody.resetTokenExpiresAt).toEqual(resetUser.resetTokenExpiresAt.toISOString());
        ...
        it("throws a generic error for an invalid client", async () => {
            ...
            dbAuth.dbInterface.dbAccessor = db.user;
            expect.assertions(1);
        });
    });
    describe("login", () => {
    ...
    describe("resetPassword", () => {
        ...
        it("throws an error if resetToken is expired", async () => {
            ...
            tokenExpires.setSeconds(tokenExpires.getSeconds() - options.forgotPassword.expires - 1);
            await createDbUser({
                resetToken: "1234",
